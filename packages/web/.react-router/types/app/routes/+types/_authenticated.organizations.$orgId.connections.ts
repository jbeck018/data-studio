...
// routes/_authenticated.organizations.$orgId.connections.tsx
...
type Module = typeof import("../_authenticated.organizations.$orgId.connections.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/_authenticated.organizations.$orgId.connections"
  file: "routes/_authenticated.organizations.$orgId.connections.tsx"
