...
// routes/_authenticated.organizations.select.tsx
...
type Module = typeof import("../_authenticated.organizations.select.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/_authenticated.organizations.select"
  file: "routes/_authenticated.organizations.select.tsx"
  path: "select"
