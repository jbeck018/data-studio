...
// routes/_authenticated.organizations.$orgId.members.tsx
...
type Module = typeof import("../_authenticated.organizations.$orgId.members.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/_authenticated.organizations.$orgId.members"
  file: "routes/_authenticated.organizations.$orgId.members.tsx"
  path: ":orgId/members"
