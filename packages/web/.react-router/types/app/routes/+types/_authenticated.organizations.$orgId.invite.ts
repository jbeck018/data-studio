...
// routes/_authenticated.organizations.$orgId.invite.tsx
...
type Module = typeof import("../_authenticated.organizations.$orgId.invite.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/_authenticated.organizations.$orgId.invite"
  file: "routes/_authenticated.organizations.$orgId.invite.tsx"
  path: ":orgId/invite"
