...
// routes/_authenticated.organizations._index.tsx
...
type Module = typeof import("../_authenticated.organizations._index.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/_authenticated.organizations._index"
  file: "routes/_authenticated.organizations._index.tsx"
  path: "undefined"
